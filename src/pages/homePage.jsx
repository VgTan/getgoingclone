...
function homePage() {
  return (
    <div className="bg-white">
      <Carousel />
      <section className="max-w-[1320px] mx-auto my-3 lg:px-0 px-4">
      ...
      <section className="lg:max-w-[1320px] m-auto mt-[3rem] lg:px-0 px-4">
        <div className="grid lg:grid-cols-2 lg:gap-0 gap-6">
          <div className="font-poppins h-full grid lg:gap-0 gap-10">
            <div className="text-[2.5rem] lg:text-start text-center">
              <span className="text-red-500 bg-cardGradient bg-clip-text text-transparent">
                PRIVATE TRIP
              </span>
              <div className="font-bold mt-5 drop-shadow-xl leading-[1.3] lg:px-0 px-4">
                <h1>
            ...
            <div className="grid lg:grid-cols-2 grid-rows-auto grid-flow-row gap-10 text-[#79819b]">
              {/* ITEM 1 */}
          ...
          <div className="lg:mr-4 bg-cardGradient rounded-l-[50px] flex items-center justify-center lg:p-10 p-5">
            <div className="grid grid-cols-2 justify-center m-auto w-full lg:py-5 lg:px-3 py-8 px-5 lg:gap-5 gap-3">
              {/* KONSUL */}
              <div className="p-5 backdrop-blur-xl bg-[#ffffff40] rounded-xl max-w-1/2 lg:h-full h-max flex flex-col gap-2 text-[1rem] font-poppins">
              ...
              {/* GUIDE */}
              <div className="p-5 backdrop-blur-xl bg-[#ffffff40] rounded-xl max-w-1/2 lg:h-full h-max flex flex-col gap-2">
                <div className="bg-white rounded-xl w-max p-3">
                  <img
      ...
      <section className="lg:max-w-[1320px] mx-auto my-12 w-full px-2">
        <h1 className="font-bold font-poppins text-3xl lg:mb-3 px-2 text-[2rem]">
