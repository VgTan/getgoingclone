    ...
    >
      <SwiperSlide>
        <div className="max-w-[1320px] flex items-center justify-between mx-auto">
          <div className="w-[45%] max-w-[50%] h-[42vh] rounded-2xl overflow-hidden">
            <img
          ...
          <div className="text-center font-mono text-lg w-[55%] pl-[12%]">
            <div className="leading-[1.5] w-full">
              <p className="tracking-[0.25em] text-[#979797] font-[50]">
            ...
            <div className="flex justify-around mt-4">
              <a
                ...
                className=""
              >
                <img className="h-[80px]" src="./images/AppStore.svg" alt="" />
              </a>
              <a
                target="_blank"
      ...
      <SwiperSlide>
        <div className="w-[1320px] flex items-center justify-between mx-auto">
          <div className="w-[47%] max-w-[50%] h-[44vh] rounded-2xl overflow-hidden">
            <img
              className="w-full h-full object-cover rounded-2xl"
          ...
          <div className="font-poppins text-base max-w-[52%] w-[50%] pr-[6%] pl-[10%]">
            <div className="">
              <p className="tracking-[0.3em] text-[#979797] font-light text-center">
                APA YANG GETGOING PUNYA?
              </p>
              <div className="font-poppins">
                {/* ITEM 1 */}
                <div className="flex items-center py-6 w-max hover:-translate-y-2 transition duration-300 cursor-pointer">
